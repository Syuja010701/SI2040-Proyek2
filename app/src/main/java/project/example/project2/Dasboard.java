    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TambahWisata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), project.example.project2.TambahWisata.class));
            }
        });
        ...
        LihatWisata.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), project.example.project2.LihatWisata.class));
            }
        });
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        ...
                        if (task.getResult().exists()){
                            ...
                            Intent intent = new Intent(Dasboard.this, project.example.project2.Profile.class);
                            startActivity(intent);
                        }
                    }
                });
